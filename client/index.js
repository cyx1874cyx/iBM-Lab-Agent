...
function injectStyles() {
  let css = [
    ...
    ".ib-project-head{display:flex;align-items:center;gap:13px;margin-bottom:20px}.ib-project-copy{flex:1;min-width:0}.ib-project-copy h1{font-size:24px;margin:0 0 4px;letter-spacing:-.025em}.ib-project-copy p{font-size:10.5px;color:var(--ib-text);margin:0}.ib-agent{display:flex;align-items:center;gap:8px}.ib-spark{width:25px;height:25px;border-radius:8px;display:grid;place-items:center;background:#023373;color:#fff;box-shadow:inset 0 0 0 1px rgba(255,255,255,.18)}.ib-spark svg{display:block;visibility:visible!important;opacity:1!important}",
