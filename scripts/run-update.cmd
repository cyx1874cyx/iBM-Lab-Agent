...
ssh -tt ubuntu@vlab.ustc.edu.cn "curl -fL --progress-bar 'https://raw.githubusercontent.com/cyx1874cyx/iBM-Lab-Agent/fix/template-list-boundary/scripts/update-agent.sh?cache=%RANDOM%' -o /tmp/update-agent.sh && chmod 700 /tmp/update-agent.sh && bash /tmp/update-agent.sh --ref main --installer-ref fix/template-list-boundary"
