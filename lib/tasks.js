...
export class LabTasksService extends Service {
	...
	/** @param config {{ skillsRoot?: string, venvDir?: string }} */
	...
	/** 创建项目：保存所选目标/模板版本快照（§五 步骤 1，§三 规则 5/6）。 */
	async createProject({ id, name, goalProfileId, goalProfileVersion, templateId, templateVersion }) {
